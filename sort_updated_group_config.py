#!/usr/bin/env python3
"""
Sort group_titles_with_flags_updated.json by exclude flag (false first) then by order
"""

import json

def main():
    print("🔄 Sorting group_titles_with_flags_updated.json by exclude flag and order...")
    
    # Load current config
    input_file = 'data/config/group_titles_with_flags_updated.json'
    ...
    # Create backup
    backup_file = 'data/config/group_titles_with_flags_updated_backup_before_sort.json'
